...
b_ind = 1:1:round((n_sample/2)); % every other sample / ~50% training sample
...
% % %          obj_eq10 ...
% % %          obj_eq5_no_added_rowcol error_count_eq5_no_added_rowcol...
% % %          obj_eq8_no_added_rowcol error_count_eq8_no_added_rowcol...
% % %          obj_eq10_no_added_rowcol];

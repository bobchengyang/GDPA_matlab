...
for dataset_i=1:1:17
    ...
    rho=0; % PSD parameter
    experiment_save_str=['results_' dataset_str '_traintest_std_latest_settings_default_82.mat'];
    %%========================================================
    ...
    for fold_i=1:K
        ...
        for rsrng=1:10
            ...
            [cL,feature,n_feature,label] = dataLoader_normalized_traintest_std(read_data_i,n_sample,b_ind,rsrng);

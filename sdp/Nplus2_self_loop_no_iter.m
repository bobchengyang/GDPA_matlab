function [cvx_optval,x_pred,err_count,u_vec,alpha,eigen_gap] = Nplus2_self_loop_no_iter(label,b_ind,n_sample,dA,dB,dL,u,alpha)
...
for i=1:n_sample+2
    if i~=n_sample+2
        ...
        AL = AL + (-sum(dz(dz_ind_plus))+u(n_sample+1)+alpha)...
            *dAnp2;
    end
end

...
for dataset_i=1:17
    ...
    experiment_save_str=['results\results_' dataset_str '_standardization_scaling.mat'];
    %%========================================================
    ...
    clearvars -except dataset_i experiment_save_str results n_train
    cvx_precision low;
    results(:,1:2:end-1)=(results(:,1:2:end-1)/n_train)*100;

...
for dataset_i=9:17
    ...
    rho=0; % PSD parameter
    experiment_save_str=['results_' dataset_str '_0to1_noise_default_82.mat'];
    %%========================================================
    ...
    for fold_i=1:K
        ...
        for rsrng=1:10
            ...
            [cL,feature,n_feature,label,label_noisy] = dataLoader_normalized_0to1_noise(read_data_i,n_sample,b_ind,rsrng);

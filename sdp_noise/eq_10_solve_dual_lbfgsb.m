function [u_opt,C_minus_opt,results] = eq_10_solve_dual_lbfgsb(data,opts)
...
fcn = @(u) eq10_calc_dual_obj_grad_lbfgsb(u,...
                                          data.A,...
                                          data.B,...
                                          data.b,...
                                          opts.sigma);
...
C_minus_opt=eq10_calc_c_minus(u_opt, data.A, data.B);
end
